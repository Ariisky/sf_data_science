...
def random_predict(number:int=1) -> int:
    ...
    min_number = 1 # задаем минимальное значение
    max_number = 100 # задаем максимальное значение
    ...
    while True:
        ...
        elif predict_number < number:  # если предполагаемое число меньше загаданного
